...
module Cardano.Api.Internal.Genesis
  ( ShelleyGenesis (..)
    ...
    , -- ledger protocol parameters
      sgProtocolParams =
        emptyPParams
          ...
          & ppMinFeeAL .~ Coin 44 -- The linear factor for the minimum fee calculation
          & ppMinFeeBL .~ Coin 155381 -- The constant factor for the minimum fee calculation
